...
export function PlasmaStage() {
  ...
  return (
    <>
      ...
      <div className="group absolute inset-x-6 bottom-[max(1.5rem,env(safe-area-inset-bottom))] z-10 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 font-mono text-[0.68rem] uppercase tracking-[0.18em] sm:inset-x-auto sm:bottom-8 sm:right-8 sm:flex-nowrap sm:justify-end">
